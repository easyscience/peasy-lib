# Contributing to EasyPeasy

Thank you for your interest in contributing to **EasyPeasy**!
...
- 💬 Ask a question or start a discussion at
  [Project Discussions](https://github.com/easyscience/peasy-lib/discussions)
...
1. Open the repository page: `https://github.com/easyscience/peasy-lib`
...
3. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/<your-username>/peasy-lib.git
   cd peasy-lib
   ```
...
4. Add the original repository as `upstream`:
   ...
   ```bash
   git remote add upstream https://github.com/easyscience/peasy-lib.git
   ```
...
Thank you for contributing to EasyPeasy and the EasyScience ecosystem!
