...
cp ../assets-branding//hero/dark.png docs/assets/images/hero_dark.png
cp ../assets-branding//hero/light.png docs/assets/images/hero_light.png
cp ../assets-branding//logos/dark.svg docs/assets/images/logo_dark.svg
cp ../assets-branding//logos/light.svg docs/assets/images/logo_light.svg
cp ../assets-branding//icons/color.png docs/assets/images/favicon.png
mkdir -p overrides/.icons/
cp ../assets-branding//icons/bw.svg overrides/.icons/.svg
